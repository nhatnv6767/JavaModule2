...
INSERT INTO Categories (category_name, catalog_description, catalog_status)
VALUES ('Electronics', 'Electronic devices and gadgets', 1),
...
INSERT INTO Product (product_id, product_name, product_price, product_title, product_description, catalog_id,
                     product_status)
VALUES ('P0001', 'Smartphone', 500.00, 'Latest Smartphone Model', 'High-performance smartphone with advanced features',
        1, 1),
       ('P0002', 'Laptop', 1200.00, 'Powerful Laptop for Work and Play', 'Lightweight laptop with a long battery life',
        1, 1),
       ...
       ('P0005', 'Refrigerator', 800.00, 'Large Capacity Refrigerator',
        'Energy-efficient refrigerator with ample storage space', 3, 1),
       ('P0006', 'Microwave Oven', 150.00, 'Multi-functional Microwave Oven',
        'Easy-to-use microwave oven with various cooking modes', 3, 1),
       ('P0007', 'Novel', 15.00, 'Bestselling Mystery Novel', 'Gripping thriller with unexpected twists', 4, 1),
       ('P0008', 'Textbook', 50.00, 'Comprehensive Textbook for Students', 'Essential textbook for academic studies', 4,
        1),
       ('P0009', 'Basketball', 30.00, 'Durable Basketball for Outdoor Play',
        'High-quality basketball for recreational use', 5, 1),
       ('P0010', 'Tent', 100.00, 'Waterproof Tent for Camping', 'Spacious and comfortable tent for outdoor adventures',
        5, 1);



INSERT INTO Categories (category_name, catalog_description, catalog_status)
VALUES ('Beauty & Personal Care', 'Cosmetics, skincare, and grooming products', 1),
...
INSERT INTO Product (product_id, product_name, product_price, product_title, product_description, catalog_id,
                     product_status)
VALUES ('P0011', 'Lipstick', 15.00, 'Long-lasting Lipstick in Various Shades',
        'Creamy and pigmented lipstick for a perfect pout', 6, 1),
       ('P0012', 'Face Cream', 30.00, 'Hydrating Face Cream for All Skin Types',
        'Moisturizing cream for a radiant complexion', 6, 1),
       ('P0013', 'Board Game', 25.00, 'Fun Board Game for the Whole Family',
        'Engaging board game for hours of entertainment', 7, 1),
       ('P0014', 'Stuffed Animal', 20.00, 'Soft and Cuddly Stuffed Animal', 'Plush toy for children of all ages', 7, 1),
       ('P0015', 'Pain Relief Medication', 10.00, 'Effective Pain Relief for Headaches and Body Aches',
        'Over-the-counter pain reliever for fast relief', 8, 1),
       ('P0016', 'Hand Sanitizer', 5.00, 'Antibacterial Hand Sanitizer', 'Kills 99.9% of germs for on-the-go hygiene',
        8, 1),
       ('P0017', 'Necklace', 100.00, 'Elegant Necklace with Pendant', 'Beautiful necklace for special occasions', 9, 1),
       ('P0018', 'Earrings', 50.00, 'Sparkling Earrings with Gemstones', 'Stylish earrings to complement any outfit', 9,
        1),
...
DELIMITER &&
CREATE PROCEDURE find_catalog_name_by_id(
    cat_id_in int
)
begin
    select c.category_name from Categories c where c.category_id = cat_id_in;
end &&
...
BEGIN
    INSERT INTO Product (product_id, product_name, product_price, product_title, product_description, catalog_id,
                         product_status)
    VALUES (product_id_in, product_name_in, product_price_in, product_title_in, product_description_in, catalog_id_in,
            product_status_in);
END &&
